...
- definite same-owner, explicitly typed parameter/local identifier receiver, explicit repository-type-qualified static, object-construction, and explicit `this`/`super` constructor calls when name/arity lookup has one repository-local target;
